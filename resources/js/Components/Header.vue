<template>
  <header>
        ...
        <div class="mx-auto max-w-2xl lg:max-w-none">
          <div class="flex items-center justify-between">
            ...
            <a aria-label="Home" href="/">
              <svg viewBox="0 0 32 32" aria-hidden="true" class="h-8 sm:hidden">
                <rect clip-path="url(#logo-clip)" class="h-8 transition-all duration-300 fill-neutral-950 w-0 group-hover/logo:w-8"></rect>
                <use href="#logo-path" class="stroke-neutral-950" fill="none" stroke-width="1.5"></use>
                <defs>
                  <path id="logo-path" d="M3.25 26v.75H7c1.305 0 2.384-.21 3.346-.627.96-.415 1.763-1.02 2.536-1.752.695-.657 1.39-1.443 2.152-2.306l.233-.263c.864-.975 1.843-2.068 3.071-3.266 1.209-1.18 2.881-1.786 4.621-1.786h5.791V5.25H25c-1.305 0-2.384.21-3.346.627-.96.415-1.763 1.02-2.536 1.751-.695.658-1.39 1.444-2.152 2.307l-.233.263c-.864.975-1.843 2.068-3.071 3.266-1.209 1.18-2.881 1.786-4.621 1.786H3.25V26Z"></path>
              ...
              <svg viewBox="0 0 130 32" aria-hidden="true" class="hidden h-8 sm:block">
                <svg viewBox="0 0 32 32" aria-hidden="true" preserveAspectRatio="xMinYMid meet">
                  <rect clip-path="url(#logo-clip-desktop)" class="h-8 transition-all duration-300 fill-neutral-950 w-0 group-hover/logo:w-8"></rect>
                  <use href="#logo-path-desktop" class="stroke-neutral-950" fill="none" stroke-width="1.5"></use>
                  <defs>
                    <path id="logo-path-desktop" d="M3.25 26v.75H7c1.305 0 2.384-.21 3.346-.627.96-.415 1.763-1.02 2.536-1.752.695-.657 1.39-1.443 2.152-2.306l.233-.263c.864-.975 1.843-2.068 3.071-3.266 1.209-1.18 2.881-1.786 4.621-1.786h5.791V5.25H25c-1.305 0-2.384.21-3.346.627-.96.415-1.763 1.02-2.536 1.751-.695.658-1.39 1.444-2.152 2.307l-.233.263c-.864.975-1.843 2.068-3.071 3.266-1.209 1.18-2.881 1.786-4.621 1.786H3.25V26Z"></path>
                    <clipPath id="logo-clip-desktop">
                      <use href="#logo-path-desktop"></use>
                    </clipPath>
                  </defs>
                </svg>
            ...
            <div class="flex items-center gap-x-8">
              <a class="inline-flex rounded-full px-4 py-1.5 text-sm font-semibold transition bg-neutral-950 text-white hover:bg-neutral-800" href="/contact">
                <span class="relative top-px">Contact us</span>
              </a>
              
              <!-- Mobile Menu Button -->
              <button type="button" aria-expanded="false" aria-controls="mobile-menu" class="group -m-2.5 rounded-full p-2.5 transition hover:bg-neutral-950/10" aria-label="Toggle navigation">
    ...
    <div id="mobile-menu" style="height: 0.5rem; transform: none; transform-origin: 50% 50% 0px;" class="relative z-50 overflow-hidden bg-neutral-950 pt-2" aria-hidden="true" inert="">
...
<script setup>
// Se necessário, adicione props, emits ou outras lógicas aqui
</script> 