<template>
  <div class="relative isolate bg-neutral-50 py-16 sm:py-28 md:py-32 mt-24 sm:mt-32 lg:mt-40">
    ...
    <svg aria-hidden="true" class="absolute inset-0 -z-10 h-full w-full fill-neutral-100 stroke-neutral-950/5 [mask-image:linear-gradient(to_bottom_left,white_50%,transparent_60%)]">
      <rect width="100%" height="100%" fill="url(#testimonial-pattern)" stroke-width="0"></rect>
      ...
      <defs>
        <pattern id="testimonial-pattern" width="96" height="480" x="50%" patternUnits="userSpaceOnUse" patternTransform="translate(0 -256)" fill="none">
      ...
      <div class="mx-auto max-w-2xl lg:max-w-none">
        <figure class="mx-auto max-w-4xl">
          <blockquote class="relative font-display text-3xl font-medium tracking-tight text-neutral-950 sm:text-4xl">
            <p class="quote-text sm:before:absolute sm:before:right-full">
          ...
          <figcaption class="mt-10">
            <img alt="Phobia" loading="lazy" width="184" height="36" src="/_next/static/media/logo-dark.353d4760.svg" />
          </figcaption>
        </figure>
      </div>
    </div>
...
<script setup>
// Se necessário, adicione props ou lógicas aqui
</script>
